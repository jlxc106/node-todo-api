...
describe("PATCH /todos/:_id", () => {
    ...
    //try to update first todo as second user assert 404
...
describe("POST /users", () => {
	...
	it("should not create user if email in use", done => {
		var email = "jay2@email.com";
		var password = "abcdefgt123";
		request(app)
			.post("/users")
			.send({ email, password })
			.expect(400)
